...
import { GAME_CONFIG, imageSettings } from './Settings.js';


export default class CactusController {
  CACTUS_INTERVAL_MIN = GAME_CONFIG.CACTUS_INTERVAL_MIN;
  CACTUS_INTERVAL_MAX = GAME_CONFIG.CACTUS_INTERVAL_MAX;
